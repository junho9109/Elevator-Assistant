...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // ── TEMP DEBUG: 별표2 덤웨이터 원문 교체 + 에스컬레이터 7.2.4 이후 잘라내기 (확인 후 제거 예정) ──
  app.get("/api/debug/fix-dumbwaiter-escalator", async (req, res) => {
    ...
    try {
      ...
      const dumbwaiterRows = [
        ...
        { ref: "5.2.2.2.2", target: "점검문/비상문", content: "• 점검문/비상문잠금장치및도어스위치모두 미작동(기능상실)" },
        { ref: "5.6.4.1", target: "피트구획/누수", content: "• 피트구획안됨\n• 피트침수(발목이상잠김)로피트검사불가" },
        ...
        { ref: "7.5.2.1.2", target: "문닫힘안전장치", content: "• 문닫힘안전장치미작동(기능상실) (동력작동식문인경우)" },
        { ref: "7.5.2.1.3", target: "승강장문외부표면", content: "• 문외부표면함몰또는돌출로인하여전달 될수있는구조임" },
        { ref: "7.7.3", target: "승강장문잠금장치", content: "• 승강장문잠금장치미작동(기능상실)" },
        { ref: "7.7.3.1.1", target: "승강장문잠금", content: "• 승강장문잠금장치가걸리지않은상태로카가 움직임" },
        { ref: "7.7.3.1.5", target: "승강장문잠금작용", content: "• 간단한충격등에의해승강장문잠금장치의 잠금이해제됨" },
        { ref: "7.7.3.2", target: "비상잠금해제 /도어클로저의작동", content: "• 승강장문도어클로저미설치또는미작동 (승강장문과카문연동방식의경우)\n• 승강장문도어클로저고정불량또는파손 등으로주행간섭및도어이탈우려있음" },
        { ref: "7.7.4.1", target: "승강장문닫힘입증 전기안전장치", content: "• 승강장문도어스위치미작동 (도어스위치단락등기능상실)\n• 승강장문도어스위치물기유입으로절연측정 안됨" },
        { ref: "8.3.1", target: "카의밀폐식구획", content: "• 카(벽/지붕/바닥등)구획안됨" },
        { ref: "8.3.2", target: "카의조립체", content: "• 카상부또는카바닥붕괴있음" },
        { ref: "8.6.3", target: "카문가이드등", content: "• 승강장문가이드슈없음 (한개의문짝가이드슈1개이상없음)\n• 가이드슈고정불량으로이탈우려있음 (한개의문짝고정볼트2개이상이탈)" },
        { ref: "9.1.5\n9.9.4.5", target: "로프파손상태", content: "• 스트랜드1개이상의파단" },
        { ref: "9.2.2.1", target: "로프끝부분의고정(소켓)", content: "• 주로프고정부이탈또는이탈우려있음" },
        { ref: "9.3.1", target: "권상기도르래", content: "• 권상기도르래모든홈언더컷잔여량1mm 미만(언더컷이없는구조제외)\n• 125%하중적재시로프가도르래에서미끄러짐\n• 권상기도르래균열또는파손\n• 도르래가권상기축에서이탈우려있음" },
        { ref: "9.7.1", target: "비상정지장치 (전기식,간접유압식)", content: "• 비상정지장치미작동(기능상실)\n• 비상정지장치한쪽만작동됨\n• 비상정지장치롤러또는쐐기가한쪽없음\n• 비상정지장치연결기구설치불량으로비상정지 장치가작동되지않는구조임" },
        { ref: "9.7.2", target: "비상정지장치 (직접유압식)", content: "• 비상정지장치미작동(기능상실)\n• 비상정지장치한쪽만작동됨\n• 비상정지장치롤러또는쐐기가한쪽없음\n• 비상정지장치연결기구설치불량으로비상정지 장치가작동되지않는구조임" },
        ...
        { ref: "10.1.1", target: "가이드레일및가이드슈 등", content: "• 가이드레일고정불량으로레일에서카또는 실린더이탈될수있음\n• 카/균형추/실린더가이드슈가레일에서이탈 되는구조임" },
        { ref: "10.3.1", target: "완충기/멈춤쇄기", content: "• 완충기미설치또는고정불량으로전도되거나 받침대로부터이탈됨\n• 고정멈춤쇄기미설치또는미작동" },
        { ref: "10.5.1.1", target: "파이널리미트스위치 (전기식덤웨이터)", content: "• 상부또는하부파이널리미트스위치미작동 (기능상실)" },
        { ref: "10.5.2.1", target: "파이널리미트스위치 (전기식덤웨이터)", content: "• 상부파이널리미트스위치미작동(기능상실)-리미트스위치모두작동안될경우" },
        { ref: "12.1", target: "구동기(유압파워유니트)", content: "• 정상운전안됨\n• 유압파워유니트카마다설치안됨" },
        ...
        { ref: "12.2.7", target: "로프/체인이완감지장치 (포지티브방식)", content: "• 주로프/체인이완감지장치미작동 (이완감지못하는등기능상실)" },
        ...
        { ref: "12.3.9.1.1", target: "수동조작비상하강밸브", content: "• 수동조작비상하강밸브미작동" },
        { ref: "12.3.12", target: "전동기공회전방지장치", content: "• 공회전방지장치미작동" },
        { ref: "12.3.13", target: "로프/체인이완감지장치 (간접유압식)", content: "• 주로프/체인이완감지정지스위치미작동 (이완감지못하는등기능상실)" },
        { ref: "13.1.3", target: "전기설비의절연저항", content: "• 각회로절연저항측정값기준미만" },
        { ref: "14.1.2.1.1", target: "", content: "• 제어회로의이상으로인한오동작발생" },
        { ref: "14.1.2.4", target: "전기안전장치등", content: "• 안전과관련회로를인위적으로단락시킨경우\n• 전기안전장치작동시구동기정지안됨" },
        { ref: "14.2.1.3", target: "전기적크리핑방지시스템", content: "• 전기적크리핑방지시스템미작동 (자동착상동시미작동시)" },
        { ref: "14.2.2.1", target: "정지장치 (피트/카지붕위/승강로내부)", content: "• 정지장치미작동(기능상실)" },
      ];

      const report: any = {};

      // 1) 덤웨이터 override 전체 교체 (사용자가 원본 문서에서 직접 붙여넣은 내용 기준)
      const dumbwaiterPayload = { title: "[별표2] 덤웨이터", rows: dumbwaiterRows };
      const existingDW = await db.select().from(inspStdOverrides).where(eq(inspStdOverrides.itemKey, "판정지침_별표2_덤웨이터")).limit(1);
      if (existingDW.length > 0) {
        await db.update(inspStdOverrides)
          .set({ text: JSON.stringify(dumbwaiterPayload), source: "판정지침_수정", updatedAt: new Date() })
          .where(eq(inspStdOverrides.itemKey, "판정지침_별표2_덤웨이터"));
        report.dumbwaiter = { action: "updated", rowCount: dumbwaiterRows.length };
      } else {
        await db.insert(inspStdOverrides).values({
          itemKey: "판정지침_별표2_덤웨이터", text: JSON.stringify(dumbwaiterPayload), source: "판정지침_수정",
        });
        report.dumbwaiter = { action: "created", rowCount: dumbwaiterRows.length };
      }

      // 2) 에스컬레이터 override — 7.2.4 이후(잘못 붙어있던 덤웨이터 내용) 잘라내기
      const existingEsc = await db.select().from(inspStdOverrides).where(eq(inspStdOverrides.itemKey, "판정지침_별표2_에스컬레이터")).limit(1);
      if (existingEsc.length > 0) {
        let payload: any;
        try { payload = JSON.parse(existingEsc[0].text || "{}"); } catch { payload = null; }
        if (payload?.rows) {
          const cutIdx = payload.rows.findIndex((r: any) => r.ref === "7.2.4");
          if (cutIdx >= 0 && payload.rows.length > cutIdx + 1) {
            ...
            await db.update(inspStdOverrides)
              ...
              .where(eq(inspStdOverrides.itemKey, "판정지침_별표2_에스컬레이터"));
            report.escalator = { action: "cut", before: payload.rows.length, after: newRows.length };
          } else {
            report.escalator = { action: "skipped", reason: "already correct or ref not found", count: payload.rows.length };
          }
        } else {
          report.escalator = { action: "skipped", reason: "no rows payload" };
        }
      } else {
        report.escalator = { action: "skipped", reason: "no override exists" };
      }
