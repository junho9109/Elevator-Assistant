...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // ── TEMP DEBUG: 별표2 경사형 휠체어리프트 원문 반영 (확인 후 제거 예정) ──
  app.get("/api/debug/fix-gyeongsahyung", async (req, res) => {
    ...
    try {
      ...
      const gyeongsaRows = [
        { ref: "4.7", target: "정격속도", content: "• 최대속도 9m/min 초과" },
        { ref: "4.8", target: "정격하중", content: "• 입석식(9.2항), 좌석식(9.3항), 복합형(9.1.4항) 정격하중이 115kg 미만\n• 휠체어(9.4항) 정격하중이 150kg 미만" },
        { ref: "4.9", target: "일반안전율", content: "• 동하중안전율 1.6 미만\n• 동하중안전율이 적절하지 않음" },
        { ref: "4.10.1", target: "내구성", content: "• 설비에 영구변형이 발생함\n• 설비에 내구성이 없음" },
        { ref: "4.10.2", target: "내구성", content: "• 편하중변형에 견디지 못함\n• 정상운전에 영향을 미침" },
        { ref: "5.1.1", target: "가이드레일", content: "• 전행정을 유도, 지지하지 않음" },
        { ref: "5.1.2", target: "가이드레일", content: "• 금속제가 아님" },
        { ref: "5.2.3", target: "접는가이드레일", content: "• 안전스위치 장착 안됨\n• 안전스위치 작동 안됨→8.6.1항에 따름" },
        { ref: "5.3", target: "가이드레일", content: "• 카가 1대 초과 설치됨\n• 협착 또는 전단의 우려가 있음" },
        { ref: "5.4", target: "기계적종단정지장치", content: "• 설치 안됨\n• 설치불량" },
        { ref: "6.1.1", target: "비상정지장치일반", content: "• 설치 안됨\n• 설치불량" },
        { ref: "6.1.2", target: "비상정지장치장착", content: "• 설치 안됨\n• 설치(장착)상태 불량" },
        { ref: "6.1.3", target: "비상정지장치해제", content: "• 설치 안됨\n• 하강방향 움직임에 해제됨\n• 장력 감소 시 해제됨\n• 다른 기구의 움직임에 해제됨" },
        { ref: "6.1.4", target: "비상정지장치정지거리", content: "• 설치 안됨\n• 150mm 이상에서 정지함" },
        { ref: "6.1.5", target: "비상정지장치제동", content: "• 설치 안됨\n• 가이드레일을 붙잡지 않음\n• 점차작동형 아님" },
        { ref: "6.1.6", target: "비상정지장치재료", content: "• 설치 안됨\n• 금속제 또는 연성재료가 아님" },
        { ref: "6.1.7", target: "비상정지장치작동시변화", content: "• 설치 안됨\n• 5°를 초과하는 경사변화 발생" },
        { ref: "6.2", target: "비상정지장치작동제어", content: "• 비상정지장치 설치 안됨\n• 조속기 설치 안됨\n• 0.3m/s을 초과해도 작동 안됨\n• 현수체인 이완, 파단 시 작동 안됨" },
        { ref: "6.3", target: "비상정지장치복귀", content: "• 설치 안됨\n• 상승방향 외의 움직임에 복귀됨\n• 복귀 후 제 기능 유지 안됨" },
        { ref: "6.5", target: "전기회로", content: "• 설치 안됨\n• 전기장치 제동 안됨\n• 구동기의 기동을 방지하지 못함" },
        { ref: "6.6", target: "조속기", content: "• 비상정지장치 설치 안됨\n• 조속기 설치 안됨\n• 0.3m/s을 초과해도 작동 안됨\n• 현수체인 파단, 이완에는 작동 안됨\n• 마찰구동기와 조속기 마찰구동이 별개가 아님\n• 1줄 현수체인식 현수체인으로 조속기를 구동함" },
        { ref: "6.7", target: "회전감지기", content: "• 조속기 회전감지회로 없음\n• 10초 또는 1m 이내에 정지 안됨\n• 1회 이상 확인기능 없음\n• 필요한 힘의 2배 미만임" },
        { ref: "6.8", target: "안전너트", content: "• 2차 너트 장착 안됨\n• 구동너트 파단 시 동력차단 안됨\n• 안전접점이 오염과 진동으로부터 보호 안됨" },
        { ref: "7.1.1", target: "구동방식", content: "• 안전도 동등 이상이 아님" },
        { ref: "7.1.2", target: "구동장치일반", content: "• 비동력식임" },
        { ref: "7.1.3", target: "구동유니트일반", content: "• 마모와 피로를 고려한 설계 안됨\n• 체결방법이 불량" },
        { ref: "7.1.4", target: "체인, 벨트동력전달기구", content: "• 출력단 기어가 부하측에 걸리지 않음\n• 자기유지형이 아님\n• 브레이크가 부하측에 위치하지 않음\n• 2개 미만의 벨트를 사용\n• 파단 시 동력을 차단하지 않음\n• 벨트 이완을 완전히 감지하지 못함" },
        { ref: "7.1.5", target: "로프(체인)이완감지장치", content: "• 이완감지장치 없음\n• 이완 시 동력차단 못함\n• 장력 재조정 전에 카가 기동함" },
        { ref: "7.2.1", target: "제동장치일반", content: "• 전자마찰브레이크 장착 안됨\n• 20mm 이내로 정지하지 못함\n• 브레이크 작동불량\n• 비정상적으로 브레이크가 개방됨" },
        { ref: "7.2.2", target: "전자브레이크", content: "• 브레이크 작동부품 체결이 확실하지 않음\n• 라이닝 정상마모 시 체결력이 약화됨\n• 동력공급이 중지된 경우 브레이크 개방됨\n• 압축스프링이 아님\n• 압축스프링이 적절히 지지 안됨" },
        { ref: "7.3.2", target: "수동하강밸브", content: "• 수동하강밸브 없음\n• 수동하강밸브를 누르지 않아도 동작\n• 수동하강밸브 작동 시 정격속도 초과하여 하강됨\n• 상승용 수동펌프 영구설치 안됨\n• 로프, 체인 이완 시 밸브 개방됨\n• 최소작동압력 이하 시 밸브 개방됨\n• 상승용 수동펌프 작동불량\n• 수동펌프 설치위치 부적합\n• 핸드펌프에 상용압력의 2.3배 제한밸브 설치 안됨" },
        { ref: "7.4.1", target: "로프", content: "• KS D 3514에 부적합함\n• 로프안전율 12 미만\n• 로프 고정부 적합\n• 로프직경 5mm 미만\n• 로프 종단연결부 안전율 10 미만\n• 로프 2줄 미만임\n• 로프 장력균등화장치 없음\n• 로프마찰구동방식임" },
        { ref: "7.4.2", target: "권동", content: "• 권동직경이 로프직경의 21배 미만임\n• 권동로프가 1.5권 미만까지 풀림" },
        { ref: "7.4.3", target: "풀리와 편향풀리", content: "• 풀리직경이 로프직경의 21배 미만임" },
        { ref: "7.5.1", target: "구동피니언", content: "• 피니언이 출력축에 고정 안됨" },
        { ref: "7.5.2", target: "구동랙", content: "• 랙이 양끝단에 부착 안됨\n• 랙이 안전하게 부착 안됨\n• 물림을 정확하게 유지시키는 장치 없음\n• 물림이 정확하지 않음\n• 랙의 심출이 정밀하지 않아 부정합이나 손상이 발생\n• 랙과 피니언 안전도가 다름" },
        { ref: "7.6.1", target: "체인휠(스프로켓)", content: "• 구동체인휠이 구동축에 부착 안됨" },
        { ref: "7.6.2", target: "체인, 벨트동력전달기구", content: "• KS B 1407에 부적합함\n• 체인안전율이 10 미만임\n• 종단부강도가 체인강도 이하임\n• 체인이 2줄 미만임\n• 체인장력이 균등하게 유지 안됨\n• 체인연결이 확실하지 않음" },
        { ref: "7.7.1", target: "구동스크류", content: "• 안전율이 6 미만임\n• 스크류 좌굴안전율이 3 미만임" },
        { ref: "7.7.2", target: "구동너트", content: "• 안전율이 스크류와 동등하지 않음" },
        { ref: "7.7.3", target: "스크류-너트조립", content: "• 한 개의 브레이크로 구동제어 안됨\n• 7.1.4항 요건 부적합\n• 회전요소가 베어링장치에 구속 안됨" },
        { ref: "7.7.5", target: "안전너트", content: "• 자기유지형이 아님\n• 비상정지장치를 대신하지 못함" },
        { ref: "7.8", target: "유도로프와 볼구동방식의 추가요건", content: "• 구속장치와 지지기구로 조합 안됨에도 1줄 로프 사용함\n• 로프안전율 12 미만임\n• 체결된 볼의 안전율이 12 미만임\n• 로프연결장치 안전율이 10 미만임" },
        { ref: "7.9.1", target: "치형세그먼트", content: "• 파손에 대한 안전율이 6 미만임\n• 인접한 세그먼트가 항상 겹치지 않음" },
        { ref: "7.9.2", target: "웜, 세그먼트의 재료", content: "• 웜의 재료가 세그먼트보다 내마모성이 약함\n• 최대정하중이 허용파단하중의 1/6을 초과함\n• 2개 이상의 이가 항상 물리지는 않음" },
        { ref: "7.9.4", target: "웜, 세그먼트구동방식의 추가요건", content: "• 조속기 미설치\n• 비상정지장치 미설치" },
        { ref: "7.10.1", target: "마찰/견인구동방식의 견인력", content: "• 정격하중의 25% 추가에서 견인 안됨\n• 마모 시 견인력이 자동유지 안됨" },
        { ref: "7.10.2", target: "마찰/견인구동방식의 재료", content: "• 구동륜의 마모나 파손 시 견인력이 최소치 이하로 감소함" },
        { ref: "7.11.2", target: "유도체인구동방식 추가요건", content: "• 지지체인과 가이드 좌굴안전율이 3 미만" },
        { ref: "7.12.1", target: "세그먼트를 갖는 유도체인 구동방식 추가요건", content: "• 현수장치 안전율이 6 미만\n• 유도체인 안전율이 10 미만" },
        { ref: "7.12.2", target: "세그먼트를 갖는 유도체인 구동방식 추가요건", content: "• 롤러와 세그먼트가 2개 이상 결합 안됨" },
        { ref: "7.13.1.1", target: "유압부품응력", content: "• 최대정지 전부하압력 고려 안됨\n• 재료보증응력의 1.7배 안전율 적용 안됨\n• 마찰손실과 피크압력의 2.3배 안전율 적용 안됨" },
        { ref: "7.13.1.2", target: "잭의 압력", content: "• 최대전하중압력의 140% 압력 고려 안됨\n• 최소안전율 2.3 고려 안됨" },
        { ref: "7.13.2", target: "잭", content: "• 잭의 구조, 연결부에 취성재료 사용\n• 잭이 축방향 하중 외의 하중을 받음\n• 잭의 한계 이상으로 로드가 주행함" },
        { ref: "7.13.3", target: "안전밸브", content: "• 안전밸브 없음" },
        { ref: "7.13.4", target: "체크밸브", content: "• 체크밸브 없음" },
        { ref: "7.13.6", target: "유압계통이상에 대한 보호", content: "• 럽처밸브 또는 동등장치 장착 안됨\n• 럽처밸브 요건이 부적합함\n• 실린더, 럽처밸브 사이의 연결방식 부적합" },
        { ref: "7.13.8", target: "압력계, 스톱밸브", content: "• 압력계 없음\n• 스톱밸브 없음" },
        { ref: "8.1.5", target: "콘덕터절연저항", content: "• 도체간/대지간 절연저항 1000Ω 미만\n• 동력회로, 안전장치회로 절연저항 500kΩ 미만\n• 기타회로 250kΩ 미만" },
        { ref: "8.2.3", target: "개폐기의 동작", content: "• 개방접저 폐쇄 시 모든 폐쇄접접 개방 안됨\n• 폐쇄접점 개방 시 모든 개방접점 폐쇄 안됨\n• 접점 융착 시 유지 안됨" },
        { ref: "8.2.4", target: "방향전환개폐기", content: "• 방향전환개폐기 전기적으로 인터록 안됨" },
        { ref: "8.3.1", target: "전동기와 브레이크회로", content: "• 전동기와 브레이크 급전 독립된 개폐기로 차단 안됨\n• 전동기와 브레이크 급전회로 내에서 직렬연결 안됨\n• 주개폐기 개방 안될 때 기동방지 안됨" },
        { ref: "8.3.2", target: "전동기와 브레이크회로", content: "• 8.4.1항과 동일하지 않음\n• 방향전환 전에 개폐기 개방 안됨\n• 개폐기 비개방 시 기동방지 안됨\n• 정지소자 동력차단용 독립제어장치 없음\n• 정지소자에 의해 동력이 차단되지 않는 경우에 감시장치 개방 안됨\n• 정지소자에 의해 동력이 차단되지 않는 경우에 기동방지 안됨" },
        { ref: "8.3.3", target: "전원공급", content: "• 전동기 브레이크 전기공급 차단상황에서 차단 안됨\n• 안전접점, 안전회로 동작 시 제동거리 200mm 초과함\n• 방향지시신호 종료 후, 전원공급 실패 시 정지거리 50mm 초과함" },
        { ref: "8.5.1", target: "전기고장에 대한 보호", content: "• 전압상실 시 오동작 유발됨\n• 전압강하 시 오동작 유발됨\n• 역상 시 오동작 유발됨\n• 절연이상 시 오동작 유발됨\n• 전기부품 고유치나 기능변화 시 오동작이 유발됨\n• 가동편 접촉불량 시 오동작 유발됨\n• 가동편 분리불량 시 오동작 유발됨\n• 접점 융착 시 오동작이 유발됨" },
        { ref: "8.5.2", target: "전기고장에 대한 보호", content: "• 안전접점 접지회로에 통전 시 정지 및 재기동 방지 안됨" },
        { ref: "8.6.1", target: "전기안전장치", content: "• 전기안전장치 없음\n• 구동전동기와 브레이크 급전에 직접 작용 안함\n• 기기의 동작정지 안됨\n• 전기안전장치 부적합" },
        { ref: "8.6.3", target: "안전스위치", content: "• 직렬회로에 설치 안됨\n• 기기보호회로에 설치됨" },
        { ref: "8.6.4", target: "안전접점", content: "• 회로차단장치에 의한 접점분리가 확실히 안됨\n• 접점 융착 시 분리 안됨\n• 부품 파손 시 안전접점 단락이 쉬움" },
        { ref: "8.6.5", target: "전도체의 마모", content: "• 전도체 마모 시 단락원인이 됨" },
        { ref: "8.6.6", target: "안전접점", content: "• 단순조작으로 접점기능이 상실됨" },
        { ref: "8.8", target: "구동전동기의 보호", content: "• 과전류에 대한 전원차단장치 없음" },
        { ref: "8.9.1.2", target: "절연", content: "• 절연성이 부적합함" },
        { ref: "8.9.2.2", target: "터미널", content: "• 도선과 절연에 손상을 일으킴" },
        { ref: "8.10.4", target: "안전회로", content: "• 안전회로가 정확히 동작하지 않아도 작동함" },
        { ref: "8.13.1", target: "무선제어방식", content: "• 무선제어대수가 1대 초과함\n• 타 무선제어방식에 응답함" },
        { ref: "8.13.2", target: "송수신기오류검출", content: "• 송신기에 오류정정수단 없음\n• 수신기에 오류정정수단 없음\n• 송신기 오류정정수단 작동불량\n• 수신기 오류정정수단 작동불량" },
        { ref: "8.13.4", target: "안전접점, 안전회로", content: "• 지시신호를 무시하지 않음\n• 20mm를 초과하여 정지함\n• 정지 안됨" },
        { ref: "8.13.5", target: "무선통신연결", content: "• 전 구간에서 유효하게 유지 안됨→8.3.3항에 따름" },
        { ref: "8.13.6", target: "무선통신연결", content: "• 신호에 이상 발생 시 안전하지 않음" },
        { ref: "8.13.7", target: "무선제어시스템안전도", content: "• 안전도가 유지 안됨" },
        { ref: "8.14.1", target: "조작장치", content: "• 누르고 있는 동안 외에도 유효함\n• 각 승강장과 카에 설치 안됨" },
        { ref: "8.14.2", target: "방향지시회로차단장치", content: "• 설치 안됨\n• 작동상태 불량" },
        { ref: "8.15.1", target: "리미트스위치와 화이날리미트스위치", content: "• 리미트스위치, 화이날리미트 설치 안됨\n• 리미트스위치, 화이날리미트 작동상태 불량\n• 화이날리미트스위치가 양방향 정지기능 안됨" },
        { ref: "8.15.2", target: "하부화이날리미트스위치 생략", content: "• 화이날리미트스위치가 생략됨" },
        { ref: "9.1.3", target: "복합형카", content: "• 규정된 안전장치가 설치 안됨" },
        { ref: "9.1.4", target: "구조", content: "• 카가 이동트롤리로 구성 안됨\n• 레일이 없음\n• 카가 확실하게 장착 안됨" },
        { ref: "9.2.3.1", target: "감지날과 감지면 장착", content: "• 발받침대 상승방향 끝에 설치 안됨\n• 발받침대 아랫면에 설치 안됨\n• 카 구조물의 상승방향과 하강방향 면에 설치 안됨\n• 카의 아래에 설치 안됨\n• 작동상태 불량" },
        { ref: "9.2.3.3", target: "감지날과 감지면 동작", content: "• 전동기와 브레이크 전원차단 안됨\n• 진행방향에서 정지 안됨\n• 안전접점과 안전회로 작동에 의해 이루어지지 않음" },
        { ref: "9.3.1", target: "입석식플랫폼", content: "• 플랫폼치수 미달\n• 손잡이, 지지대 설치 안됨" },
        { ref: "9.3.4.1", target: "감지날과 감지면 장착", content: "• 플랫폼의 상승방향 끝에 설치 안됨\n• 플랫폼의 아랫면에 설치 안됨\n• 카 구조물의 상승방향과 하강방향 면에 설치 안됨\n• 카의 아래에 설치 안됨\n• 작동상태 불량" },
        { ref: "9.3.4.3", target: "감지날과 감지면 동작", content: "• 전동기와 브레이크 전원차단 안됨\n• 진행방향에서 정지 안됨\n• 안전접점과 안전회로 작동에 의해 이루어지지 않음" },
        { ref: "9.4.2", target: "플랫폼의 치수", content: "• 플랫폼치수 미달" },
        { ref: "9.4.4.1", target: "램프의 설치 및 경사도", content: "• 램프 설치 안됨\n• 램프 설치상태 불량" },
        { ref: "9.4.4.2", target: "램프의 높이", content: "• 100mm 미만임\n• 램프 없음" },
        { ref: "9.4.6.2", target: "보호대, 램프잠금장치", content: "• 올려진 램프 자동잠금 안됨\n• 잠금장치 걸리지 않아도 리프트 작동함" },
        { ref: "9.4.6.3", target: "경사형 휠체어리프트의 보호대", content: "• 탈착가능한 보호대 설치 안됨\n• 보호대 설치상태 불량" },
        { ref: "9.4.7.1", target: "감지날과 감지판의 동작", content: "• 플랫폼의 상승방향 끝에 설치 안됨\n• 플랫폼의 아랫면에 설치 안됨\n• 접은 플랫폼의 아랫면에 설치 안됨\n• 카의 아래에 설치 안됨\n• 작동상태 불량" },
        { ref: "9.4.7.3", target: "감지날, 감지판의 동작", content: "• 전동기와 브레이크 전원차단 안됨\n• 진행방향에서 정지 안됨\n• 안전접점과 안전회로 작동에 의해 이루어지지 않음" },
        { ref: "9.4.9", target: "보호대, 램프의 잠금장치", content: "• 300N의 힘에 영구변형이 발생\n• 1000N의 힘에 보호대 견디지 못함" },
        { ref: "10.1.3", target: "전기적 시험", content: "• 도선간 대지간 절연저항 1000Ω 미만인\n• 동력회로, 안전장치회로 500kΩ 미만임\n• 기타회로 500kΩ 미만임\n• 노출금속과 주접지단자 0.5Ω 초과\n• 플랫폼과 레일에 접지시킨 회로차단기 또는 퓨즈차단 안됨" },
        { ref: "10.1.4", target: "조속기, 비상정지장치시험", content: "• 조속기트립속도 적정하지 않음\n• 비상정지장치기능 적정하지 않음\n• 비상정지장치 작동 안됨\n• 비상정지장치 설치 안됨" },
      ];

      const keys = ["판정지침_별표2_전기식", "판정지침_별표2_유압식", "판정지침_별표2_덤웨이터", "판정지침_별표2_소형", "판정지침_별표2_수직형", "판정지침_별표2_경사형"];
      ...
      const sources = [
        ["전기식", byKey["판정지침_별표2_전기식"]?.rows || []],
        ["유압식", byKey["판정지침_별표2_유압식"]?.rows || []],
        ["덤웨이터", byKey["판정지침_별표2_덤웨이터"]?.rows || []],
        ["소형", byKey["판정지침_별표2_소형"]?.rows || []],
        ["수직형", byKey["판정지침_별표2_수직형"]?.rows || []],
      ] as const;

      const reformatted: any[] = [];
      const finalGyeongsa = gyeongsaRows.map((row) => {
        for (const [srcName, srcRows] of sources) {
      ...
      const existingGyeongsa = byKey["판정지침_별표2_경사형"];
      const title = existingGyeongsa?.title || "[별표2] 경사형 휠체어리프트";

      let applied = false;
      if (req.query.apply === "1") {
        const payload = { title, rows: finalGyeongsa };
        const gExisting = await db.select().from(inspStdOverrides).where(eq(inspStdOverrides.itemKey, "판정지침_별표2_경사형")).limit(1);
        if (gExisting.length > 0) {
          await db.update(inspStdOverrides)
            .set({ text: JSON.stringify(payload), source: "판정지침_수정", updatedAt: new Date() })
            .where(eq(inspStdOverrides.itemKey, "판정지침_별표2_경사형"));
        } else {
          await db.insert(inspStdOverrides).values({ itemKey: "판정지침_별표2_경사형", text: JSON.stringify(payload), source: "판정지침_수정" });
        }
        applied = true;
      }
      ...
      res.json({
        applied,
        gyeongsaRowCount: finalGyeongsa.length,
