...
-- 1) 텍스트 수정
UPDATE public.inspection_base_items SET text = '1 적용 범위
...
UPDATE public.inspection_base_items SET text = '2 인용 표준
이 기준에서 인용하는 표준은 그 최신판을 적용한다.', section_title = '2 인용 표준', updated_at = now() WHERE item_id = '2';
UPDATE public.inspection_base_items SET text = '3.9 기계류 공간(machinery space)
...
UPDATE public.inspection_base_items SET text = '3.21 안전 로프(safety rope)
...
UPDATE public.inspection_base_items SET text = '3.35 잠금해제구간(unlocking zone)
카가 해당 정지층의 승강장문이 잠기지 않게 할 수 있는 상·하 한계 구간', section_title = '3.35 잠금해제구간(unlocking zone)', updated_at = now() WHERE item_id = '3.35';
UPDATE public.inspection_base_items SET text = '6.1 일반사항', section_title = '6.1 일반사항', updated_at = now() WHERE item_id = '6.1';
UPDATE public.inspection_base_items SET text = '6.1.5.1 피트에는 다음과 같은 장치가 있어야 한다.
...
UPDATE public.inspection_base_items SET text = '6.2.1 승강로, 기계실·기계류 공간, 풀리실 및 관련 작업구역은 접근이 가능해야 한다. 카 내부를 제외하고 관계자만이 접근할 수 있게 해야 한다.(부속서 Ⅴ 참조)', section_title = '6.2.1 승강로, 기계실·기계류 공간, 풀리실 및 관련 작업구역은 접근이 가능해야 한다. 카 내부를 제외하고 관계자만이 접근할 수 있게 해야 한다.(부속서 Ⅴ 참조)', updated_at = now() WHERE item_id = '6.2.1';
UPDATE public.inspection_base_items SET text = '6.4 표시', section_title = '6.4 표시', updated_at = now() WHERE item_id = '6.4';
UPDATE public.inspection_base_items SET text = '15.2.6 안전 관련 프로그램 적용 가능한 전자시스템(PESSRAL)
...
UPDATE public.inspection_base_items SET text = '6.5 승강로', section_title = '6.5 승강로', updated_at = now() WHERE item_id = '6.5';
UPDATE public.inspection_base_items SET text = '7.1 일반사항', section_title = '7.1 일반사항', updated_at = now() WHERE item_id = '7.1';
UPDATE public.inspection_base_items SET text = '7.5.2 방화 등급
...
UPDATE public.inspection_base_items SET text = '7.7.1 승강장 조명
...
DELETE FROM public.inspection_base_items WHERE item_id = '18.2';